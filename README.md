...
inst/extdata/tx\_counties\_demo.gpkg A simplified Texas counties layer in EPSG:4326, containing only the counties used in the demo (e.g. Deaf Smith, Gaines).
...
nass\_cotton <- read.csv(system.file("extdata", "nass\_demo\_cotton.csv", package = "NAYD"))

tx\_cnties   <- sf::st\_read(system.file("extdata", "tx\_counties\_demo.gpkg", package = "NAYD"))



compute\_weights\_batch(

&nbsp; nass\_df     = nass\_cotton,

&nbsp; years       = 2018:2020,

&nbsp; counties\_sf = tx\_cnties,
...
&nbsp; system.file("extdata", "TX\_WW\_PLAN\_HARV\_Y\_demo.csv", package = "NAYD")

)



tx\_counties <- sf::st\_read(

&nbsp; system.file("extdata", "tx\_counties\_demo.gpkg", package = "NAYD"),
...
counties <- unique(nass\_ww$county\_raw\_name)  # or a subset



seg\_df\_ww <- run\_disagg\_clustering\_batch(

&nbsp; years       = years,

&nbsp; counties    = counties,

&nbsp; nass\_table  = nass\_ww,

&nbsp; counties\_sf = tx\_counties,

&nbsp; crop\_name   = "winter wheat",
